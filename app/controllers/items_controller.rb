class ItemsController < ApplicationController
  ...
  keyword = params[:keyword]
    unless keyword.nil?
      ...
      @items = Item.search(:title_or_author_or_note_or_holding_cont_any => [keyword_itai, keyword_seiji], code_eq: keyword, m: 'or').result
    else
      @items = Item.search(:title_or_author_or_note_or_holding_cont => keyword).result
    end
    unless @items.any?
